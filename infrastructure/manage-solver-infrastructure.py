...
def arg_parser() -> dict: 
    ...
    parser.add_argument('--project', required = False, default = 'comp25', help = "ADVANCED USERS ONLY: Name of the project (default: 'comp25').")
...
def main() -> None: 
    ...
    if args.solver_type == "cloud":
        ...
        instance_type =  'm6i.16xlarge'#'m6i.16xlarge'
        memory = '253000'
    else:
