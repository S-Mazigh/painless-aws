...
# else
    # parallel setup
    echo "PARALLEL SETUP: "
    command="./painless -v=$verbosity -c=$nb_solvers -solver=k -t=5000 -shr-strat=1 -shr-sleep=100000 -prs -ga-init=2 -ga-max-gen=500 -ga-mut-rate=0.88 -ga-cross-rate=0.95 -gshr-strat=-1 $2"
# fi
